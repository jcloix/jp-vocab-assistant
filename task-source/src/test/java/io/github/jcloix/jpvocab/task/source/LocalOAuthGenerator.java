 ...
 */
public class LocalOAuthGenerator {
        ...
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(
                ...
                new InputStreamReader(
                        Objects.requireNonNull(
                                LocalOAuthGenerator.class.getClassLoader()
                                        .getResourceAsStream(clientSecretPath),
                                "client_secret.json not found in test resources"
                        )
                )
        );
